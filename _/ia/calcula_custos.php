...
$retorno_fim['categoria'] = $dados_retorno;
$retorno_fim['dados']['km'] = $km;
$retorno_fim['dados']['minutos'] = $minutos;
$retorno_fim['dados']['taxa'] = $taxa;
$retorno_fim['dados']['encontrou'] = $encontrou;
header('Content-Type: application/json');
echo json_encode($retorno_fim, JSON_UNESCAPED_UNICODE);
